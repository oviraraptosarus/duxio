...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden pb-12 pt-[5.25rem] md:pb-20 md:pt-[7.5rem]">
      <div className="container-shell grid gap-10 lg:grid-cols-[0.98fr_0.96fr] lg:items-center xl:grid-cols-[0.95fr_0.98fr]">
        <div>
          ...
          <Reveal delay={0.08}>
            <h1 className="serif max-w-[11.5ch] text-balance text-[clamp(2.15rem,8vw,4.95rem)] leading-[0.94] tracking-[-0.052em] text-[var(--ink)]">
          ...
          <Reveal delay={0.16}>
            <p className="mt-6 max-w-xl text-base leading-7 text-[var(--ink-muted)] md:text-[1.05rem] md:leading-8">
              Duxio builds the systems that respond faster, qualify better,
              book cleaner, and follow up automatically, so good leads stop
              disappearing between tools.
            </p>
          </Reveal>
